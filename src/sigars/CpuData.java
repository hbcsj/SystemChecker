...
public class CpuData {
	...
	public CpuData(Sigar s) throws SigarException {
		sigar = s;
		CpuPerc   cpuPerc  = sigar.getCpuPerc();     // CPU 사용량
		System.out.println(CpuPerc.format(cpuPerc.getIdle()));
		System.out.println(CpuPerc.format(cpuPerc.getUser()));
	}

	public static void getCpuData() throws InterruptedException, SigarException {
...
//		}
	...
	public static Double[] getMetric() throws SigarException {
		...
		System.out.println("idle: " + CpuPerc.format(idle) + ", system:" + CpuPerc.format(system) + ", user: "
				+ CpuPerc.format(user));
